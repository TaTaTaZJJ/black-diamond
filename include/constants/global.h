...
// 背包容量（栏位持有上限99个）
#define BAG_MEDICINE_COUNT         20
#define BAG_POKEBALLS_COUNT        27
#define BAG_BATTLEITEMS_COUNT      12
#define BAG_BERRIES_COUNT          85
#define BAG_COLLECTION_COUNT       40
#define BAG_MEGASTONE_COUNT        47

// 背包容量（栏位持有上限1个）*注意这里必须是8的倍数
#define BAG_EXPLORATIONKIT_COUNT   24
#define BAG_KEYITEMS_COUNT         32
#define BAG_TMHM_COUNT             304
#define BAG_COSTUMES_COUNT         16
#define BAG_ZCRYSTALS_COUNT        40

#define BAG_EXPLORATIONKIT_BYTES   (BAG_EXPLORATIONKIT_COUNT / 8)
#define BAG_KEYITEMS_BYTES         (BAG_KEYITEMS_COUNT / 8)
#define BAG_THHM_BYTES             (BAG_TMHM_COUNT / 8)
#define BAG_COSTUMES_BYTES         (BAG_COSTUMES_COUNT / 8)
#define BAG_ZCRYSTALS_BYTES        (BAG_ZCRYSTALS_COUNT / 8)
