...
const u32 gBagScreenMale_Pal[] = INCBIN_U32("graphics/interface/bag_screen.gbapal.lz");
const u32 gBagScreenFemale_Pal[] = INCBIN_U32("graphics/interface/bag_screen.gbapal.lz");

const u32 gBagPocketIconTiles[] = INCBIN_U32("graphics/interface/bag_pocket_icons.4bpp.lz");
const u32 gBagSelectedPocketIconTiles[] = INCBIN_U32("graphics/interface/bag_pocket_selected_icons.4bpp.lz");
