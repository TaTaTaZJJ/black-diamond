...
const u8 gText_DefaultNameLucy[] = _("小蓟");
...
const u8 gText_CollectionPocket[] = _("收藏品");
...
const u8 gText_Collection[] = _("收藏品");
...
const u8 gText_CantSelectSamePkmn[] = _("不能选择相同的{PKMN}。");
...
const u8 gText_Kira[] = _("基拉");
const u8 gText_Amy[] = _("久美");
const u8 gText_John[] = _("约翰");
const u8 gText_Roy[] = _("罗伊");
const u8 gText_Gabby[] = _("嘉比");
